...
In the current page there is a breaf explanation of the [several phases](#Pre-Processing) within the widely available [web application](https://jorgeserras.shinyapps.io/outlierdetection/), references and additional published material should be examined for additional insight.

scroll down enphase [use it today](#usage) with name of header
