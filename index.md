...
In the [current page](#Pre-Processing) there is a breaf explanation of the several phases within the widely available [web application](https://jorgeserras.shinyapps.io/outlierdetection/), references and additional published material should be examined for additional insight.
