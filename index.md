...
Instructions for the offline employment of the web application when downloaded is available **[below](#usage)** along with information concerning **[input data](#input-data)**. In the current page there is a breaf explanation of the **[several phases](#pre-processing)** within the widely available **[web application](https://jorgeserras.shinyapps.io/outlierdetection/)**. References and additional published material should be examined for additional insight.
